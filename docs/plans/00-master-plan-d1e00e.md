...
- **Two-mode UX**: the dashboard surfaces the _right_ abstraction (template wizard for non-tech, deploy logs + git for devs) instead of one bloated form.
...
- **@kubernetes/client-node** — _server-side only_, for orchestrator module
